...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~CASE WHEN  &quot;featureCode&quot;  =  15404 OR  &quot;featureCode&quot;  =  15407  THEN  color_rgb(157, 113, 51) WHEN &quot;featureCode&quot; = 15403 OR &quot;featureCode&quot; = 15409 THEN color_rgba(157, 113, 51, 0) WHEN &quot;featureCode&quot; = 15210 THEN color_rgba(26, 26, 26, 0) WHEN  &quot;featureCode&quot;  =  15403 THEN  color_rgb(224, 148, 94) WHEN  &quot;featureCode&quot;  =  15409 THEN  color_rgb(224, 148, 94) WHEN  &quot;featureCode&quot;  =  15603 THEN  color_rgb(0, 154, 207) WHEN  &quot;featureCode&quot;  =  15015 THEN  color_rgb(72, 64, 60) ELSE  color_rgb(0, 0, 0) END~~"/>
    <property key="labeling/dataDefined/Family" value="1~~1~~CASE WHEN  &quot;font&quot;  =  0  OR  &quot;font&quot;  =  2  THEN 'Times New Roman' ELSE 'Arial' END~~"/>
    <property key="labeling/dataDefined/FontStyle" value="1~~1~~CASE WHEN  &quot;font&quot;  =  0  THEN 'Italic' WHEN  &quot;font&quot;  =  4 OR  &quot;featureCode&quot; = 15015 THEN 'Bold' ELSE 'Normal'END~~"/>
    ...
    <property key="labeling/dataDefined/MinScale" value="1~~1~~CASE WHEN  &quot;height&quot; > 14 THEN 3700 END~~"/>
    <property key="labeling/dataDefined/Rotation" value="1~~1~~&quot;orientation&quot;  / 10~~orientation"/>
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE WHEN  &quot;featureCode&quot; = 15701 THEN &quot;height&quot; * 1.25 ELSE &quot;height&quot; END~~height"/>
    ...
    <property key="labeling/fieldName" value="CASE WHEN  &quot;featureDescription&quot;  NOT LIKE  '%, road%' THEN  &quot;textString&quot;  END"/>
    ...
    <property key="labeling/scaleMin" value="1000"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="anchorPosition"/>
    <edittype labelontop="0" editable="1" name="font"/>
    <edittype labelontop="0" editable="1" name="height"/>
    <edittype labelontop="0" editable="1" name="orientation"/>
    <edittype labelontop="0" editable="1" name="textString"/>
  </edittypes>
